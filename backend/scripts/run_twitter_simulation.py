...
class TwitterSimulationRunner:
    ...
    def _create_model(self):
        ...
        优先使用 llm_registry.json 中的 twitter_agent route；
        未配置时回退到 legacy LLM_* env。
        """
        resolved = Config.get_llm_config("TWITTER_AGENT")
        ...
        print(
            f"LLM配置[twitter_agent]: profile={profile_id}, provider={provider_id}, "
